  ...
  return (
    <VantaWavesBackground className="min-h-screen" darkOverlay={true}>
      <main className="max-w-4xl mx-auto p-6 pt-8">
        <h1 className="text-3xl font-bold mb-2 text-white drop-shadow-lg">🗂️ Flashcards</h1>
        <p className="text-gray-100 mb-8 drop-shadow-md">Generate AI flashcards for any topic</p>
